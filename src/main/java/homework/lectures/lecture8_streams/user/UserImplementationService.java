...
public class UserImplementationService {
    ...
    List<User> userList = new ArrayList<>() {{
        ...
        add(new User(4L, "Olga", "Sidorova", "OSidorova", 13, "osidorova@gmail.com", "sDGS!<sf4", UserStatus.VIPUSER, true));
        ...
        add(new User(8L, "Roman", "Hilkevich", "RHilkevich", 40, "rhilkevich@gmail.com", "asdasdasdad", UserStatus.VIPUSER, true));
        add(null);
    }};
}
